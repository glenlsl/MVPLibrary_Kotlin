package travelsky.fulinpolice.mvplibrary.component;
...
import solin.mvplibrary.util.ToastUtil;
...
//        LLOG.e(ex.toString());
//        LLOG.e(collectCrashDeviceInfo());
//        LLOG.e(getCrashInfo(ex));
        // 调用系统错误机制
        defaultHandler.uncaughtException(thread, ex);
        ToastUtil.show("抱歉,程序发生异常即将退出");
        AppManager.get().exitApp();
    }
